...
namespace shift.yggdrasil2.cicd.scheduler
{
    class Config
    {
        ...
        public string K8sAPIHelperURI { get; set; }
        public string K8sNamespace { get; set; }
        public string K8sYggdrasil2RunnerStatefulSetName { get; set; }
        ...
        public static Config LoadFromEnvironment(string filename)
        {
            ...
            var k8sAPIHelperURI = Environment.GetEnvironmentVariable("k8s_api_helper_uri");
            if (!string.IsNullOrWhiteSpace(k8sAPIHelperURI)) { c.K8sAPIHelperURI = k8sAPIHelperURI; }

            var k8sNamespace = Environment.GetEnvironmentVariable("k8s_namespace");
            if (!string.IsNullOrWhiteSpace(k8sNamespace)) { c.K8sNamespace = k8sNamespace; }

            var k8sYggdrasil2RunnerStatefulSetName = Environment.GetEnvironmentVariable("k8s_yggdrasil2_runner_statefulset_name");
            if (!string.IsNullOrWhiteSpace(k8sYggdrasil2RunnerStatefulSetName)) { c.K8sYggdrasil2RunnerStatefulSetName = k8sYggdrasil2RunnerStatefulSetName; }
